...
class Model(Base):
	...
	allocation = relationship("ModelPosition", back_populates="model", cascade="all, delete, delete-orphan")
...
class ModelPosition(Base):
	...
	trade_prices = relationship("Price", back_populates="model_position", cascade="all, delete, delete-orphan")

	def as_dict(self):
		result = {'model_id': self.model_id, 'symbol': self.symbol, 'weight': self.weight}
		return result