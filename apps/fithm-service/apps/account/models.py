...
class Account(Base):
	...
	account_positions = relationship("AccountPosition", back_populates="account", cascade="all, delete, delete-orphan")
...
class AccountPosition(Base):
    ...
    trade_prices = relationship("Price", back_populates="account_position", cascade="all, delete, delete-orphan")
