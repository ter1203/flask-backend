...
class Trade(Base):
	...
	pendings = relationship("Pending", back_populates="trade", cascade="all, delete, delete-orphan")
	prices = relationship("Price", back_populates="trade", cascade="all, delete, delete-orphan")
